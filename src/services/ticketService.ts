...
export interface Ticket {
  ...
  client_id: string; // ID do cliente que criou
  client_name?: string; // Nome do cliente já armazenado
  assigned_to?: string; // ID do técnico atribuído
  technician_id?: string; // ID do técnico atribuído
  technician_name?: string; // Nome do técnico já armazenado
...
export const updateTicket = async (id: string, ticketData: TicketUpdate): Promise<Ticket | null> => {
  ...
  if (ticketData.technician_id) updateData.technician_id = ticketData.technician_id;
  if (ticketData.technician_name) updateData.technician_name = ticketData.technician_name;
